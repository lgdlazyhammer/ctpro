...
import com.lgd.ctpro.taskexecutor.TestDisplayOrderTaskRecorder;
...
public class TestThreadPool {
	...
	public static void main(String[] args) {
        ...
        TestDisplayOrderTaskRecorder testDisplayOrderTaskRecorder = new TestDisplayOrderTaskRecorder();
        testDisplayOrderTaskRecorder.start();
